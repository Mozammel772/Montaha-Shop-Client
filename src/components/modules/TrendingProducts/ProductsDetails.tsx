...
export default function ProductDetails({ product }: any) {
  ...
  const handleAddToCart = () => {
    if (isAlreadyInCart) {
      toast.error(`${product.shortTitle} already added`);
      return;
    }
  ...
  return (
    <section className="min-h-screen bg-gray-50">
      ...
      <div className="border-b border-t bg-white">
        <div className="max-w-[1400px] mx-auto flex items-center justify-start gap-2 text-[13px] text-gray-500 overflow-x-auto whitespace-nowrap px-2 py-3">
