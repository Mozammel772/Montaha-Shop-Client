...
//   return (
//     <section className="py-6 bg-[#F1F5F9] w-full">
...
//             <button
//               onClick={prevSlide}
//               className="absolute left-2 md:left-3 top-1/2 -translate-y-1/2 h-6 w-6 md:h-11 md:w-11 rounded-full bg-[#0f3ea9] text-white flex items-center justify-center shadow-lg hover:scale-105 duration-300 z-20"
//             >
...
//             <button
//               onClick={nextSlide}
//               className="absolute right-2 md:right-2 top-1/2 -translate-y-1/2 h-6 w-6 md:h-11 md:w-11 rounded-full bg-[#0f3ea9] text-white flex items-center justify-center shadow-lg hover:scale-105 duration-300 z-20"
//             >
//               <ChevronRight className="w-5 h-5" />
//             </button>

//             {/* DOTS */}
//             <div className="absolute bottom-2 md:border-5 left-1/2 -translate-x-1/2 flex items-center gap-2 z-20">
//               {banners.map((_, index) => (
//                 <button
//                   key={index}
...
//             {/* TOP CARD */}
//             <div className="relative overflow-hidden rounded-lg group h-24 md:h-48">
//               <Image
//                 src={sideImageOne}
//                 alt="Fashion Banner"
//                 fill
...
//               {/* CONTENT */}
//               <div className="absolute top-4 md:top-8 left-4 md:left-6 z-10">
//                 <p className="text-xs md:text-lg leading-[18px] md:leading-[34px] font-bold text-[#032b75] max-w-[240px]">
//                   New Summer Fashion
//                 </p>

//                 <p className="text-orange-500 font-semibold mt-1 md:mt-2 text-xs md:text-lg">
//                   Handbag
//                 </p>
//               </div>
//             </div>
...
//               {/* CONTENT */}
//               <div className="absolute top-4 md:top-8 left-4 md:left-6 z-10">
//                 <p className="text-xs md:text-lg leading-[18px] md:leading-[34px] font-bold text-[#032b75] max-w-[260px]">
